    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sale_price2', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='precio venta2')),
                ('sale_price3', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='precio venta3')),
