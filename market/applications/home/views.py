...
class PanelAdminView(AdminPermisoMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["total_ventas"] = Sale.objects.total_ventas_dia(id_user)
        context["total_anulaciones"] = Sale.objects.total_ventas_anuladas_dia(id_user)
        context["stok_cero"] = Product.objects.productos_en_cero().count()
        context["resumen_semana"] = SaleDetail.objects.resumen_ventas(id_user)[:7]
        return context
